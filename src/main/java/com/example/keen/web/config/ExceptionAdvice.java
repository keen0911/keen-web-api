package com.example.keen.web.config;

import cn.dev33.satoken.exception.NotLoginException;
import cn.hutool.json.JSONObject;
import com.example.keen.web.exception.KeenException;
...
public class ExceptionAdvice {
    ...
    public String exceptionHandler(Exception e) {
        ...
        //处理业务异常
        else if (e instanceof KeenException) {
            log.error("执行异常", e);
            KeenException exception = (KeenException) e;
